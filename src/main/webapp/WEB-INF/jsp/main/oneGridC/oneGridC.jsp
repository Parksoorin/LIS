...
<body>
	...
	<div class="up">
		<div class="up-btn">
			<button class="btn">
				<img src="/images/search.png" class="icon">조회
			</button>
			<button class="btn">
				<img src="/images/save.png" class="icon">저장
			</button>
		</div>
	</div>
	...
	<div class="down">
		<div class="down-left">
			...
			<div class="down-left-btn">
				<!-- 아래.왼쪽.위.버튼 -->
				<button class="btn">
					<img src="/images/search.png" class="icon">입력
				</button>
				<button class="btn">
					<img src="/images/delete.png" class="icon-x">삭제
				</button>
			</div>
			<div class="down-left-text">
				<select id="left-select"></select>
				<button class="FC-btn">
					<img src="/images/search.png" class="icon">Find
				</button>
				<button class="FC-btn">
					<img src="/images/clear.png" class="icon">Clear
				</button>
			</div>
			<div style="height: auto; overflow: auto;">
				<table id="lisc001DTO"></table>
			</div>
		</div>
		...
		<div class="down-right">
			...
			<div class="down-right-up">
				...
				<div class="down-right-btn">
					...
					<button class="btn">
						<img src="/images/settings.png" class="icon">컬럼설정
					</button>
				</div>
				<div style="height: 30vh; overflow: auto;">
					<table id="lisc002DTO"></table>
				</div>
			</div>
